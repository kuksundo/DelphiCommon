...
-----------------------------------------------------------------------------}
unit JvgXMLSerializer_Encrypt2;
...
type
  TJvgXMLSerializer_Encrypt2 = class(TJvgXMLSerializer)
  public
...
{ TJvgXMLSerializer_Encrypt2 }

constructor TJvgXMLSerializer_Encrypt2.Create(AOwner: TComponent);
begin
  inherited;
  //inherited Create(AOwner);
end;

procedure TJvgXMLSerializer_Encrypt2.DeSerialize_Encrypt(Component: TObject;
...
destructor TJvgXMLSerializer_Encrypt2.Destroy;
begin
  inherited;
end;
...
//IsEncrypt:
procedure TJvgXMLSerializer_Encrypt2.LoadFromXMLFile(AComponent: TObject;
...
procedure TJvgXMLSerializer_Encrypt2.SaveToXMLFile(AComponent: TObject; AFileName: string;
                  APassphrase: string = ''; AIsEncrypt: Boolean = false);
var
  Fs: TFileStream;
begin
...
procedure TJvgXMLSerializer_Encrypt2.Serialize_Encrypt(Component: TObject;
  Stream: TStream; APassphrase: string);
var
  LMemStream: TMemoryStream;
begin
