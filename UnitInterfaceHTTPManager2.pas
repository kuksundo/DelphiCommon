unit UnitInterfaceHTTPManager2;

interface

uses System.SysUtils,
  mormot.core.base, mormot.orm.core, mormot.rest.client, mormot.rest.http.client
;
...
begin
  ...
  begin
    ...
    FHTTPClient := TRestHttpClient.Create(FServerIP, FPortName, FModel);
