...
{    FXAxisIData: TpjhString200;
  ...
  public
    ...
    function LoadFromSqliteFile(ADBFileName: string; AEngParamKind: TEngParamListItemKind = eplikNull): integer; override;
    function SaveToSqliteFile(ADBFileName: string; AItemIndex: integer=-1): integer; override;
    function LoadFromSqliteFile4Secure(ADBFileName: string; AEngParamKind: TEngParamListItemKind = eplikNull): integer; override;
...
function TEngineParameter.LoadFromSqliteFile(ADBFileName: string;
...
function TEngineParameter.LoadFromSqliteFile4Secure(
  ADBFileName: string; AEngParamKind: TEngParamListItemKind): integer;
begin
  InitEngineParamClient(ADBFileName);
  ...
  try
    ...
    if Result = 1 then
      Result := LoadFromSqliteFile(ADBFileName, AEngParamKind);
  finally
